...
set(command "/cvmfs/sft.cern.ch/lcg/contrib/CMake/3.18.3/Linux-x86_64/bin/cmake;-Dmake=${make};-Dconfig=${config};-P;/build/jenkins/workspace/lcg_nightly_pipeline/build/externals/Python-3.9.6/src/Python-3.9.6-stamp/Python-3.9.6-install-impl.cmake")
execute_process(
  COMMAND ${command}
  RESULT_VARIABLE result
  OUTPUT_FILE "/build/jenkins/workspace/lcg_nightly_pipeline/build/externals/Python-3.9.6/src/Python-3.9.6-stamp/Python-3.9.6-install.log"
  ERROR_FILE "/build/jenkins/workspace/lcg_nightly_pipeline/build/externals/Python-3.9.6/src/Python-3.9.6-stamp/Python-3.9.6-install.log"
  )
if(result)
  ...
  foreach(arg IN LISTS command)
    set(msg "${msg} '${arg}'")
  endforeach()
  file(SHA1 "/build/jenkins/workspace/lcg_nightly_pipeline/build/externals/Python-3.9.6/src/Python-3.9.6-stamp/Python-3.9.6-install.log" sha1)
  set(msg "${msg}\nSee also\n  /build/jenkins/workspace/lcg_nightly_pipeline/build/externals/Python-3.9.6/src/Python-3.9.6-stamp/Python-3.9.6-install.log [${sha1}]\n")
  file(APPEND /build/jenkins/workspace/lcg_nightly_pipeline/build/fail-logs.txt "/build/jenkins/workspace/lcg_nightly_pipeline/build/externals/Python-3.9.6/src/Python-3.9.6-stamp/Python-3.9.6-install.log\n")
  message(FATAL_ERROR "${msg}")
else()
  set(msg "Python-3.9.6 install command succeeded.  See also /build/jenkins/workspace/lcg_nightly_pipeline/build/externals/Python-3.9.6/src/Python-3.9.6-stamp/Python-3.9.6-install.log\n")
  message(STATUS "${msg}")
endif()
