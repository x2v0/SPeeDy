...
set_target_properties(ROOT::ROOTVecOps PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "ROOT::Core;/cvmfs/sft.cern.ch/lcg/releases/vdt/0.4.3-992df/x86_64-centos7-gcc11-opt/lib/libvdt.so"
)
...
# Create imported target ROOT::cppyy_backend3_9
add_library(ROOT::cppyy_backend3_9 SHARED IMPORTED)

set_target_properties(ROOT::cppyy_backend3_9 PROPERTIES
  INTERFACE_LINK_LIBRARIES "ROOT::Core;dl"
)

# Create imported target ROOT::cppyy3_9
add_library(ROOT::cppyy3_9 SHARED IMPORTED)

set_target_properties(ROOT::cppyy3_9 PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/cvmfs/sft-nightlies.cern.ch/lcg/latest/Python/3.9.6-b0f98/x86_64-centos7-gcc11-opt/include/python3.9"
  INTERFACE_LINK_LIBRARIES "-Wl,--unresolved-symbols=ignore-all;ROOT::cppyy_backend3_9"
)

# Create imported target ROOT::ROOTPythonizations3_9
add_library(ROOT::ROOTPythonizations3_9 SHARED IMPORTED)

set_target_properties(ROOT::ROOTPythonizations3_9 PROPERTIES
  INTERFACE_LINK_LIBRARIES "-Wl,--unresolved-symbols=ignore-all;ROOT::Core;ROOT::Tree;ROOT::cppyy3_9"
)
...
set_target_properties(ROOT::PyROOT3 PROPERTIES
  INTERFACE_LINK_LIBRARIES "ROOT::cppyy_backend3_9;ROOT::cppyy3_9;ROOT::ROOTPythonizations3_9"
)
...
# Create imported target ROOT::JupyROOT3_9
add_library(ROOT::JupyROOT3_9 SHARED IMPORTED)
...
set_target_properties(ROOT::RMySQL PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;/cvmfs/sft-nightlies.cern.ch/lcg/latest/mysql/10.4.20-c0154/x86_64-centos7-gcc11-opt/include/mysql"
  INTERFACE_LINK_LIBRARIES "ROOT::Core;ROOT::Net;ROOT::RIO;-L/cvmfs/sft-nightlies.cern.ch/lcg/latest/mysql/10.4.20-c0154/x86_64-centos7-gcc11-opt/lib/ -lmariadb"
)

# Create imported target ROOT::Oracle
add_library(ROOT::Oracle SHARED IMPORTED)
...
set_target_properties(ROOT::RSQLite PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;/cvmfs/sft.cern.ch/lcg/releases/sqlite/3320300-3c47f/x86_64-centos7-gcc11-opt/include"
  INTERFACE_LINK_LIBRARIES "ROOT::Core;ROOT::Net;ROOT::RIO;/cvmfs/sft.cern.ch/lcg/releases/sqlite/3320300-3c47f/x86_64-centos7-gcc11-opt/lib/libsqlite3.so"
)
...
set_target_properties(ROOT::RooBatchCompute PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;/cvmfs/sft.cern.ch/lcg/releases/vdt/0.4.3-992df/x86_64-centos7-gcc11-opt/include"
  INTERFACE_LINK_LIBRARIES "ROOT::Core;ROOT::MathCore"
)
