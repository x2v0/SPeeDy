...
list(APPEND _IMPORT_CHECK_FILES_FOR_ROOT::Hbook "${_IMPORT_PREFIX}/lib/libHbook.so" )
...
# Import target "ROOT::GFAL" for configuration "Release"
set_property(TARGET ROOT::GFAL APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(ROOT::GFAL PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libGFAL.so"
  IMPORTED_SONAME_RELEASE "libGFAL.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS ROOT::GFAL )
list(APPEND _IMPORT_CHECK_FILES_FOR_ROOT::GFAL "${_IMPORT_PREFIX}/lib/libGFAL.so" )

# Import target "ROOT::DCache" for configuration "Release"
set_property(TARGET ROOT::DCache APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(ROOT::DCache PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libDCache.so"
  IMPORTED_SONAME_RELEASE "libDCache.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS ROOT::DCache )
list(APPEND _IMPORT_CHECK_FILES_FOR_ROOT::DCache "${_IMPORT_PREFIX}/lib/libDCache.so" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_ROOT::RDAVIX "${_IMPORT_PREFIX}/lib/libRDAVIX.so" )
...
# Import target "ROOT::cppyy_backend3_9" for configuration "Release"
set_property(TARGET ROOT::cppyy_backend3_9 APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(ROOT::cppyy_backend3_9 PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libcppyy_backend3_9.so"
  IMPORTED_SONAME_RELEASE "libcppyy_backend3_9.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS ROOT::cppyy_backend3_9 )
list(APPEND _IMPORT_CHECK_FILES_FOR_ROOT::cppyy_backend3_9 "${_IMPORT_PREFIX}/lib/libcppyy_backend3_9.so" )

# Import target "ROOT::cppyy3_9" for configuration "Release"
set_property(TARGET ROOT::cppyy3_9 APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(ROOT::cppyy3_9 PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libcppyy3_9.so"
  IMPORTED_SONAME_RELEASE "libcppyy3_9.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS ROOT::cppyy3_9 )
list(APPEND _IMPORT_CHECK_FILES_FOR_ROOT::cppyy3_9 "${_IMPORT_PREFIX}/lib/libcppyy3_9.so" )

# Import target "ROOT::ROOTPythonizations3_9" for configuration "Release"
set_property(TARGET ROOT::ROOTPythonizations3_9 APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(ROOT::ROOTPythonizations3_9 PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libROOTPythonizations3_9.so"
  IMPORTED_SONAME_RELEASE "libROOTPythonizations3_9.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS ROOT::ROOTPythonizations3_9 )
list(APPEND _IMPORT_CHECK_FILES_FOR_ROOT::ROOTPythonizations3_9 "${_IMPORT_PREFIX}/lib/libROOTPythonizations3_9.so" )
...
set_target_properties(ROOT::ROOTTPython PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "ROOT::cppyy3_9"
...
# Import target "ROOT::JupyROOT3_9" for configuration "Release"
set_property(TARGET ROOT::JupyROOT3_9 APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(ROOT::JupyROOT3_9 PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libJupyROOT3_9.so"
  IMPORTED_SONAME_RELEASE "libJupyROOT3_9.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS ROOT::JupyROOT3_9 )
list(APPEND _IMPORT_CHECK_FILES_FOR_ROOT::JupyROOT3_9 "${_IMPORT_PREFIX}/lib/libJupyROOT3_9.so" )
...
# Import target "ROOT::Oracle" for configuration "Release"
set_property(TARGET ROOT::Oracle APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(ROOT::Oracle PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOracle.so"
  IMPORTED_SONAME_RELEASE "libOracle.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS ROOT::Oracle )
list(APPEND _IMPORT_CHECK_FILES_FOR_ROOT::Oracle "${_IMPORT_PREFIX}/lib/libOracle.so" )
