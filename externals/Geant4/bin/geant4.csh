...
if ( ! ${?LD_LIBRARY_PATH} ) then
  setenv LD_LIBRARY_PATH /cvmfs/sft.cern.ch/lcg/releases/clhep/2.4.5.1-ebe73/x86_64-centos7-gcc11-opt/lib
else
  setenv LD_LIBRARY_PATH ${LD_LIBRARY_PATH}:/cvmfs/sft.cern.ch/lcg/releases/clhep/2.4.5.1-ebe73/x86_64-centos7-gcc11-opt/lib
endif
...
if ( ! ${?LD_LIBRARY_PATH} ) then
  ...
  setenv LD_LIBRARY_PATH ${LD_LIBRARY_PATH}:/cvmfs/sft.cern.ch/lcg/releases/XercesC/3.2.3-714f6/x86_64-centos7-gcc11-opt/lib
endif
...
# Resource file paths
# - Datasets
setenv G4NEUTRONHPDATA "/cvmfs/geant4.cern.ch/share/data/G4NDL4.6"
setenv G4LEDATA "/cvmfs/geant4.cern.ch/share/data/G4EMLOW8.0"
...
setenv G4ABLADATA "/cvmfs/geant4.cern.ch/share/data/G4ABLA3.1"
setenv G4INCLDATA "/cvmfs/geant4.cern.ch/share/data/G4INCL1.0"
