#Sun Jul 31 03:17:26 2022"""Automatically generated. DO NOT EDIT please"""
import sys
...
class CallgrindProfile( ConfigurableAlgorithm ) :
  ...
  _propertyDocDct = { 
    ...
    'StartFromEventN' : """ After what event we start profiling. [CallgrindProfile] """,
    'StopAtEventN' : """ After what event we stop profiling. If 0 than we also profile finalization stage. Default = 0. [CallgrindProfile] """,
    'DumpAtEventN' : """ After what event we stop profiling. If 0 than we also profile finalization stage. Default = 0. [CallgrindProfile] """,
    'ZeroAtEventN' : """ After what event we stop profiling. If 0 than we also profile finalization stage. Default = 0. [CallgrindProfile] """,
    'DumpName' : """ Label for the callgrind dump [CallgrindProfile] """,
  }
  __declaration_location__ = 'CallgrindProfile.cpp:25'
